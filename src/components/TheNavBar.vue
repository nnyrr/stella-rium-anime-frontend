  ...
  <header class="fixed top-0 w-full z-50 transition-all duration-300 border-b border-white/40 bg-white/70 backdrop-blur-xl shadow-sm/50">
    <div class="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
      ...
      <router-link to="/" class="flex items-center gap-3 cursor-pointer group select-none">
        <div class="relative w-11 h-11 bg-gradient-to-br from-[#1E88E5] to-cyan-400 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20 group-hover:rotate-6 group-hover:scale-105 transition-all duration-300">
